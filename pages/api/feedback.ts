...
export default async function handler(
  ...
  res: NextApiResponse<any>
    ...
    const conversation = [
         {
          role: "system",
            content: ` You are a expert english teacher. You correct students mistakes by giving valuable and insightful feedbacks.
    ...
    const ollama = new Ollama({ host: "localhost:3000" })
